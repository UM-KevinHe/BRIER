...
# contents. Filters to .rda / .RData / .rds extensions. The intent is
# to help a user say "what BRIER-ready files are in my data folder?"
# without leaving the Claude conversation.
