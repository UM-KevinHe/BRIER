...
For genetic risk prediction using GWAS summary statistics, `BRIER` also provides the helper function `PreprocessS()` for standard preprocessing in `BRIERs` modeling. Details are provided in [Appendix: Data Processing of Genetic Risk Prediction using BRIERs](Appendix_Appendix_Preprocess.html).
