...
# Best eta: ( 0.774, 0.167 )
# Best lambda: 0.752 
```

Function `plot.eta` can be used to guide and visualize the selection of the best performing integration weight $\eta$, according to different evaluation metrics used in the validation set. For multiple external cohorts (>1), `plot.eta` do not generate ggplot objects for plotting but only generate summary results. The user could visualize using XXX as illustrated below. The below figure displays the heat map of predictive performance (here, MSPE for a Gaussian outcome) evaluated on the validation set as a function of $\eta_1$ and $\eta_2$. The optimal integration weight is identified as the value of $\eta$ combination that minimizes the evaluation criterion.
...
# 1 0.0000000     0 gaussian.mspe 137.9169        NA        NA
# 2 0.1000000     0 gaussian.mspe 135.6191        NA        NA
# 3 0.1668101     0 gaussian.mspe 133.8548        NA        NA
# 4 0.2782559     0 gaussian.mspe 131.5709        NA        NA
# 5 0.4641589     0 gaussian.mspe 129.7242        NA        NA
# 6 0.7742637     0 gaussian.mspe 129.2638        NA        NA
